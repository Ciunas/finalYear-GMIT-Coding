...
public class ResultSetTableModel extends AbstractTableModel {
   ...
   public ResultSetTableModel( String driver, String url, 
      String query ) throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
      // load database driver class
      Class.forName( "com.mysql.jdbc.Driver").newInstance();

      // connect to database
      connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1/books","root","root" );
